...
public class GameBYMode extends GameSetup implements ActionListener {
    ...
    GameBYMode(int numHumanPlayers, String player1, String player2, String player3, String player4,
    ...
    private JPanel getPlayer3Panel() {
        ...
        player3Panel.setBorder(BorderFactory.createLineBorder(new Color(128, 0, 128), 4));
        return player3Panel;
    }
    ...
    private JPanel getPlayer4Panel() {
        ...
        player4Panel.setBorder(BorderFactory.createLineBorder(Color.ORANGE, 4));
        return player4Panel;
    }
